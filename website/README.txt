...
3) To view the site you will need to run a local HTTP server that uses the
   website/output/ directory as its document root.  Contact Nat Pryce if you
   don't have one; he has a little Ruby script that does just that.

4) To deploy the site, commit your changes to CVS.  The continuous integration system
   will build the site and deploy it onto www.jmock.org.
...
1) Integrate more project reports into the skin
