...
public class AssertMoTest extends TestCase
{
    ...
    public void testAssertExcludes() {
        AssertMo.assertExcludes("Should not include substring",
                                "dog",
                                "The quick brown fox");
    }
    ...
    public void testAssertExcludesFails() {
        ...
        try {
            AssertMo.assertExcludes("Should fail on exclude",
                                    "fox",
                                    "The quick brown fox");
        }
    ...
    public void testAssertIncludes() {
        AssertMo.assertIncludes("Should include a substring",
                                "fox",
                                "The quick brown fox");
    }
    ...
    public void testAssertIncludesFails() {
        Throwable result = null;
        try {
            AssertMo.assertIncludes("Should fail if no include",
                                    "dog",
                                    "The quick brown fox");
        }
        catch (AssertionFailedError ex) {
    ...
    public void testAssertStartsWith() {
        AssertMo.assertStartsWith("Should start with fox",
                                  "fox",
                                  "fox quick brown");
    }
    ...
    public void testAssertStartsWithFails() {
        Throwable result = null;
        try {
            AssertMo.assertStartsWith("Should fail if it doesn't start with fox",
                                      "fox",
                                      "The quick brown fox");
        }
        catch (AssertionFailedError ex) {
    ...
    public void testDifferentArrays() {
        ...
        try {
            AssertMo.assertEquals("Should be expected value",
                                  anExpectedArray,
                                  anActualArray);
        }
