...
import uk.jamesdal.perfmock.auto.internal.Mockomatic;
 ...
 * It wraps a {@link Mockery} and automatically asserts that
...
public abstract class MockObjectTestCase extends VerifyingTestCase {
    ...
    private void initialise() {
        context.setExpectationErrorTranslator(AssertionErrorTranslator.INSTANCE);
