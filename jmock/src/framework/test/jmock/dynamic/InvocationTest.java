...
public class InvocationTest extends TestCase {
    ...
    public void testCanBeConstructedWithExplicitCallDetails() {
        Invocation call = new Invocation( INVOKED, DECLARING_CLASS, 
    ...
    public void testConstructorInterpretsNullParameterValueArrayAsZeroArguments() {
        Invocation call = new Invocation( INVOKED,DECLARING_CLASS, 
                                          METHOD_NAME, new Class[0], RETURN_TYPE,
                                          null);
    ...
    public void testTestsForEqualityOnTargetAndMethodSignatureAndArguments() {
        Invocation call1 = new Invocation(INVOKED,DECLARING_CLASS,
                METHOD_NAME, ARG_TYPES, RETURN_TYPE, ARG_VALUES);
        Invocation call2 = new Invocation(INVOKED,DECLARING_CLASS,
                METHOD_NAME, ARG_TYPES, RETURN_TYPE, ARG_VALUES);
        Invocation differentTarget = new Invocation("OTHER TARGET",DECLARING_CLASS,
                METHOD_NAME, ARG_TYPES, RETURN_TYPE, ARG_VALUES);
        Invocation differentName = new Invocation(INVOKED,DECLARING_CLASS,
                "other" + METHOD_NAME, ARG_TYPES, RETURN_TYPE, ARG_VALUES);
        Invocation differentReturnType = new Invocation(INVOKED,DECLARING_CLASS,
                METHOD_NAME, ARG_TYPES, int.class, ARG_VALUES);
        Invocation differentArgTypes = new Invocation(INVOKED,DECLARING_CLASS,
                METHOD_NAME, new Class[]{double.class}, RETURN_TYPE, ARG_VALUES);
        Invocation differentArgValues = new Invocation(INVOKED,DECLARING_CLASS,
                METHOD_NAME, ARG_TYPES, RETURN_TYPE, 
    ...
    public void testFollowsEqualsHashcodeProtocol() {
        Invocation call1 = new Invocation(INVOKED,DECLARING_CLASS,METHOD_NAME, 
                ARG_TYPES, RETURN_TYPE, ARG_VALUES);
        Invocation call2 = new Invocation(INVOKED,DECLARING_CLASS,METHOD_NAME, 
                ARG_TYPES, RETURN_TYPE, ARG_VALUES);
